...
public class RenderOverlayMusicDisplay implements Drawable {
	...
	public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
		...
		// Background
		DrawableHelper.fill(matrixStack, 0, 0, width, height, 0xFF212121);
		...
		DrawableHelper.fill(matrixStack, 6, 23, width - 6, 26, 0xFF555555);
		DrawableHelper.fill(matrixStack, 6, 23, 6 + (int) ((width - 12) * progress), 26, 0xFF3E9100);
